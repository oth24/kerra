...
<body>
 ...
 <section class="categories">
    ...
    <div class="wrapper"><br>
        ...
        <h2 style="text-align: center;"> تسجيل دخول المستخدم</h2> <br>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
			...
			<a href="register_client.php">	<input type="button" class="btn btn-muted" value="انشاء مستخدم جديد"> </a>
            </div>
		...
		<br>
		<div style="text-align: center;">
		<a href="login_admin.php">	<input type="button" class="btn btn-muted" value=" دخول الادارة"> </a>
		 </div>
    </div>  
    </div>
